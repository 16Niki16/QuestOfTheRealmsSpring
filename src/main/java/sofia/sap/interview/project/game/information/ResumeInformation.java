...
public record ResumeInformation(String characterName, String locationName, int health, int mana) implements ViewInformation{
    public static ResumeInformation of(Character character, Room currentRoom) {
        ...
        return new ResumeInformation(character.getCharacterName(), currentRoom.getName(),
